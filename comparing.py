...
for l in range(k+1):
    ...
    if l < (len(listluft)):
        ...
        plt.plot(datei, isfj[listluft[l]], '.', color='purple', markersize = 2, label="isfjord "+listluft[0])
...
for l in range(k+1):
    ...
    if l < (len(listluft)):
        plt.plot(isfj[listluft[l]+'day'], isfj[listluft[l]], '.', color='purple', markersize = 2, label="nordenskioldbreen "+listnorden[l])
        plt.plot(luft[listluft[l]+'day'], luft[listluft[l]], '.', color='green', markersize = 2, label="ulvebreen "+listulven[0])
