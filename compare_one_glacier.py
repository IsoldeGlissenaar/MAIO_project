# -*- coding: utf-8 -*-
"""
Created on Tue Oct 16 12:34:04 2018
...
ax1.scatter(nomask_dates, T_nomask[:,0], label='Stoa' , s=10, c='b') #norden
ax1.set_xlabel('date')
...
ax2 = ax1.twinx()
ax2.scatter(nomask_dates, T_nomask[:,1], label= 'THUT', s=10, c='g') #ulve
ax2.set_ylabel('THUT')
ax2.tick_params('y')
