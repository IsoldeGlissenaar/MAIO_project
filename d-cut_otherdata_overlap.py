...
T_ulve=np.load(direc+"avgNordenskioldbreen/"+data_ulve+".npy")
T_ulveday=np.load(direc+"avgNordenskioldbreen/"+data_ulve+"day.npy")
...
T_luft=np.load(direc+"avgNordenskioldbreen/"+data_luft+".npy")
T_luftday=np.load(direc+"avgNordenskioldbreen/"+data_luft+"Day.npy")
